...
\makefigure{ht}{
   \includegraphics[width=6.7in]{figures/problem_analysis/conceptualframework.png}
...
\makefigure{ht}{
   \includegraphics[width=\linewidth, angle=90]{figures/problem_analysis/facultyloadingbpmn.jpeg}
   \caption{The faculty loading process}
